    ...
    return (
        <div className="container mb-5 ">
            <div className="row p-5 mb-5">
                <h2 className=" mt-5 " style={{textAlign:"center",opacity:"1"}}>We pioneered the discount broking model in India.<br/>
                    Now, we are breaking ground with our technology.</h2>
            </div>
           
            <div className="row mt-5 border-top text-muted" style={{lineHeight:"1.8",fontSize:"1.2em"}}>
